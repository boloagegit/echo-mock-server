const _app = createApp({
    setup() {
        ...
        const ruleFormCtx = useRuleForm({ showToast, showConfirm, t, requireLogin, login, loadRules, rulePreviewCache, rulePreviewExpanded, rulesMarkDirty: rulesCtx.markDirty, loadResponseSummary: loadResponseOptions, responseSummary: responseOptions, responsesMarkDirty: responsesCtx.markDirty, responseSseEvents, renderEditor, editEditorRef, editFormatted, previewEditorRef, previewFormatted, responseFormEditorRef, responseFormFormatted, detectMode, editors, jmsEnabled });
